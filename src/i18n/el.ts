const el: Record<string, string> = {
  ...
  // ── Hero ──
  'hero.badge': 'Χωρίς φούμαρα. Χωρίς δράματα. Απλά κώδικας που δουλεύει.',
  'hero.title1': 'Ο Κώδικάς Σου Είναι',
  'hero.titleHighlight1': 'Χάλια',
  'hero.title2': 'Πάμε να τον',
  'hero.titleHighlight2': 'Φτιάξουμε',
  'hero.subtitle':
